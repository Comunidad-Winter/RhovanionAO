...
Dim ind As Integer
ind = Val(general_field_read(2, List1.List(List1.listIndex), Asc("-")))
End Sub
...
Private Sub mnuBorrar_Click()
    ...
    'Pablo (ToxicWaste)
    Dim aux As String
    aux = mid$(general_field_read(1, List1.List(List1.listIndex), Asc("-")), 10, Len(general_field_read(1, List1.List(List1.listIndex), Asc("-"))))
...
Private Sub mnuIR_Click()
    ...
    '/Pablo (ToxicWaste)
    'Call WriteGoToChar(general_field_read(1, List1.List(List1.listIndex), Asc("-")))
...
Private Sub mnutraer_Click()
    ...
    'Pablo (ToxicWaste)
    'Call WriteSummonChar(general_field_read(1, List1.List(List1.listIndex), Asc("-")))
End Sub
