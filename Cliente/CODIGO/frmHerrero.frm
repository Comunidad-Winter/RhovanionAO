...
On Error Resume Next
    ...
    ElseIf lstCascos.Visible Then
        Call WriteCraftBlacksmith(CascosHerrero(lstCascos.listIndex + 1))
    Else
        Call WriteCraftBlacksmith(EscudosHerrero(lstEscudos.listIndex + 1))
    End If
