...
Image1.Picture = LoadPicture(DirGraficos & "Botónok.jpg")
...
For i = 0 To NUMSKILLS * 2 - 1
    If i Mod 2 = 0 Then
        command1(i).Picture = LoadPicture(DirGraficos & "BotónMás.jpg")
    Else
        command1(i).Picture = LoadPicture(DirGraficos & "BotónMenos.jpg")
    End If
Next
