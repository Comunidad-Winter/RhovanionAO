...
UserList(UserIndex).Faccion.Alineacion = CLng(UserFile.GetValue("FACCIONES", "Alineacion"))
...
UserList(UserIndex).Faccion.NeutralesMatados = CLng(UserFile.GetValue("FACCIONES", "NeutMatados"))
UserList(UserIndex).Faccion.RangoFaccionario = CLng(UserFile.GetValue("FACCIONES", "RangoFaccionario"))
...
If NumQuest > 0 Then
    ReDim UserList(UserIndex).Quest.UserQuest(1 To NumQuest) As tQuest
    For LoopC = 1 To NumQuest
        UserList(UserIndex).Quest.UserQuest(LoopC).estado = val(UserFile.GetValue("QUEST" & LoopC, "Estado"))
        UserList(UserIndex).Quest.UserQuest(LoopC).NpcInfo.amount = val(UserFile.GetValue("QUEST" & LoopC, "Amount"))
        UserList(UserIndex).Quest.UserQuest(LoopC).NpcInfo.NpcIndex = val(UserFile.GetValue("QUEST" & LoopC, "NpcIndex"))
    Next LoopC
End If
...
Call WriteVar(UserFile, "FLAGS", "Montado", CStr(UserList(UserIndex).flags.Montado))
...
Call WriteVar(UserFile, "FACCIONES", "RangoFaccionario", CStr(UserList(UserIndex).Faccion.RangoFaccionario))
...
Call WriteVar(UserFile, "FACCIONES", "NeutMatados", CStr(UserList(UserIndex).Faccion.NeutralesMatados))
...
'GUARDAMOS LA INFO DE QUEST DEL USUARIO
If UBound(UserList(UserIndex).Quest.UserQuest) >= NumQuest Then
    For LoopC = 1 To NumQuest
        Call WriteVar(UserFile, "QUEST" & LoopC, "Estado", CStr(UserList(UserIndex).Quest.UserQuest(LoopC).estado))
        Call WriteVar(UserFile, "QUEST" & LoopC, "NpcAmount", CStr(UserList(UserIndex).Quest.UserQuest(LoopC).NpcInfo.amount))
        Call WriteVar(UserFile, "QUEST" & LoopC, "NpcIndex", CStr(UserList(UserIndex).Quest.UserQuest(LoopC).NpcInfo.NpcIndex))
    Next LoopC
End If
