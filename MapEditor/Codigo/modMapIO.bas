...
Seek FreeFileInf, 1
    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
                ...
                If MapData(X, y).light_index Then ByFlags = ByFlags Or 32
                ...
                If MapData(X, y).particle_group_index Then ByFlags = ByFlags Or 128
                ...
                If MapData(X, y).base_light(0) Or MapData(X, y).base_light(1) _
                    ...
                    If MapData(X, y).base_light(0) Then _
                        Put FreeFileMap, , MapData(X, y).light_base_value(0)
                    If MapData(X, y).base_light(1) Then _
                        Put FreeFileMap, , MapData(X, y).light_base_value(1)
                    If MapData(X, y).base_light(2) Then _
                        Put FreeFileMap, , MapData(X, y).light_base_value(2)
                    If MapData(X, y).base_light(3) Then _
                        Put FreeFileMap, , MapData(X, y).light_base_value(3)
                End If
...
On Error Resume Next
    ...
    LightDestroyAll
    modDXEngine.DXEngine_ParticleGroupDestroyAll
    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            Get FreeFileMap, , MapData(X, y).Graphic(1).Grh_Index
            Grh_Initialize MapData(X, y).Graphic(1), MapData(X, y).Graphic(1).Grh_Index
            
            'Layer 2 used?
            If ByFlags And 2 Then
                Get FreeFileMap, , MapData(X, y).Graphic(2).Grh_Index
                Grh_Initialize MapData(X, y).Graphic(2), MapData(X, y).Graphic(2).Grh_Index
            Else
                MapData(X, y).Graphic(2).Grh_Index = 0
            End If
            ...
            If ByFlags And 4 Then
                Get FreeFileMap, , MapData(X, y).Graphic(3).Grh_Index
                Grh_Initialize MapData(X, y).Graphic(3), MapData(X, y).Graphic(3).Grh_Index
            Else
                MapData(X, y).Graphic(3).Grh_Index = 0
            End If
            ...
            If ByFlags And 8 Then
                Get FreeFileMap, , MapData(X, y).Graphic(4).Grh_Index
                Grh_Initialize MapData(X, y).Graphic(4), MapData(X, y).Graphic(4).Grh_Index
            Else
                MapData(X, y).Graphic(4).Grh_Index = 0
            End If
            ...
            If ByFlags And 64 Then
                ...
                If MapData(X, y).base_light(0) Then _
                    Get FreeFileMap, , MapData(X, y).light_base_value(0)
                
                If MapData(X, y).base_light(1) Then _
                    Get FreeFileMap, , MapData(X, y).light_base_value(1)
                
                If MapData(X, y).base_light(2) Then _
                    Get FreeFileMap, , MapData(X, y).light_base_value(2)
                
                If MapData(X, y).base_light(3) Then _
                    Get FreeFileMap, , MapData(X, y).light_base_value(3)
            End If
            
            If ByFlags And 128 Then
                Get FreeFileMap, , TempInt
                MapData(X, y).particle_group_index = DXEngine_ParticleGroupCreate(X, y, TempInt, -1)
            End If
