   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.Frame cLuces 
         ...
         Begin WorldEditor.lvButtons_H cQuitarLuz 
            ...
            cBack           =   -2147483633
         End
         Begin WorldEditor.lvButtons_H cInsertarTodoLuz 
            Height          =   600
            Left            =   1980
            TabIndex        =   109
            Top             =   1155
            ...
            _ExtentX        =   2937
            _ExtentY        =   1058
            Caption         =   "Insertar a todo el mapa"
            CapAlign        =   2
            BackStyle       =   2
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
            ...
            cBack           =   -2147483633
         End
         Begin WorldEditor.lvButtons_H cQuitarTodoLuz 
            Height          =   600
            Left            =   1995
            TabIndex        =   110
            Top             =   1860
            ...
            cBack           =   -2147483633
         End
         Begin WorldEditor.lvButtons_H cLuzAmbiente 
            Height          =   600
            Left            =   1980
            TabIndex        =   111
            Top             =   405
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":305888
         Left            =   1080
         List            =   "frmMain.frx":305898
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":3058A8
         Left            =   120
         List            =   "frmMain.frx":3058AA
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":3058AC
         Left            =   3360
         List            =   "frmMain.frx":3058AE
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":3058B0
         Left            =   840
         List            =   "frmMain.frx":3058B2
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":3058B4
         Left            =   120
         List            =   "frmMain.frx":3058B6
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":3058B8
         Left            =   840
         List            =   "frmMain.frx":3058BA
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":3058BC
         Left            =   3360
         List            =   "frmMain.frx":3058BE
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":3058C0
         Left            =   120
         List            =   "frmMain.frx":3058C2
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":3058C4
         Left            =   120
         List            =   "frmMain.frx":3058C6
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":3058C8
         Left            =   840
         List            =   "frmMain.frx":3058CA
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":3058CC
         Left            =   120
         List            =   "frmMain.frx":3058CE
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":3058D0
         Left            =   3360
         List            =   "frmMain.frx":3058D2
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
