...
'*************************************************
    ...
    If Button = vbLeftButton Then
        ...
        If frmMain.cInsertarParticula Then
            ...
            MapData(tX, tY).particle_group_index = modDXEngine.DXEngine_ParticleGroupCreate(tX, tY, Val(frmMain.txtParticula), -1)
            MapData(tX, tY).Particle_Index = Val(frmMain.txtParticula)
        ElseIf frmMain.cQuitarParticula Then
            If MapData(tX, tY).particle_group_index Then
                Call modDXEngine.DXEngine_ParticleGroup_Destroy(MapData(tX, tY).particle_group_index)
